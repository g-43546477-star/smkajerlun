...
Migrasi bermula `20260814101336` hingga `20260826162435` mempunyai SQL yang
...
- Jalankan migrasi melalui workflow Supabase yang digunakan oleh project,
  kemudian sahkan dengan `list_migrations` dan `npm run health:check`.
