(function () {
  ...
  if (daily) daily.textContent = 'Ahli: Ahmadinejad, Nur Ali\'yah Nafeesah, Muhammad Wafiy, Hanania, Ahmad Aniq Naimullah dan Auni Sofiyyah.';
  var tvpss = document.querySelector('#pelajar .support-grid article:first-child p');
  if (tvpss) tvpss.textContent = 'Ahmad Hasani bin Mohd Nazir, Ahmad Husaini bin Mohd Nazir, Aisyah Dhia Amani binti Khairul Nizam, Nur Ainul Mardhiah binti Mohamad dan Aina Afifah binti Harun.';
}());
