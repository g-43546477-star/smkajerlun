...
;
cmsLoadPage('akademik','academic-content-blocks',{excludeTitles:['Takwim Akademik']});cmsLoadAkademikHighlights({calendarId:'academic-calendar',noticeId:'academic-notices',calendarLimit:3,noticeLimit:2});cmsLoadAuthNav();
